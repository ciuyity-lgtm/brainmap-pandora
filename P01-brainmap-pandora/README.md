...
### 数据（brainmap_data.json）
**All Rights Reserved** © ciuyi — 脑图数据自有版权，未经授权不得用于商业目的。

### 代码（HTML / JS / 样式）
**All Rights Reserved** © ciuyi — 代码开源供学习参考，但不授予商业使用、分发、修改的许可。

> 如果你想在商业项目中使用本项目的任何内容，请联系作者获取授权。
